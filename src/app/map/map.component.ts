...
export class MapComponent implements AfterViewInit {
  ...
  ngOnInit(): void {
    ...
    this.histogramService.rectangle.subscribe(rect => {
  ...
  startDrawRectangle() {
    ...
    this.map.on('draw:created', (e: any) => {
      ...
      let result = geoblaze.histogram(this.georasterObj, e.layer.toGeoJSON(), { scaleType, numClasses, classType });
      console.log(result);
    })
  }
